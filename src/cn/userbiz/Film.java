...
//		t1 = new JLabel("图1");
		...
		this.add(cinema);		this.add(login);		this.add(beijing);
		this.add(shai);		this.add(gz);		this.add(kb);
		this.add(q1);	this.add(q2);	this.add(q3);	this.add(q4);	this.add(q5);
		this.add(dongzuo);		this.add(zhanzheng);		this.add(xiju);
		this.add(dongman);		this.add(kehuan);		this.add(mb);

		this.add(city);	this.add(area);	this.add(type);	this.add(mb1);
		this.add(hhxd); this.add(zl2);	this.add(xbyz); this.add(wbsys);
		this.add(mcgj);this.add(ndmz);this.add(mzt);this.add(dlds);
		

		this.add(t1);	this.add(t2);	this.add(t3);	this.add(t4);
		this.add(n1);	
		this.add(n2);	this.add(n3);	this.add(n4);
		this.add(s1);	this.add(s2);	this.add(s3);	this.add(s4);
		this.setTitle("电影");
...
//			n1.getText();
		...
		}else if(e.getSource()==dlds)
		{
			...
			List<cn.bean.Cinema> list3=cinemaDao.findCinemaByArea(11);
			for(cn.bean.Cinema ce:list3){
				String x=ce.getName();
				String y=ce.getAddress();
			}
		}
