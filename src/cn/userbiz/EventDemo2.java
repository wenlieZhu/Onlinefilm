...
public class EventDemo2 {
    ...
    public void getButtonss(){
        ...
        //创建图片容器并赋予图片路径
        //可选择座位
        ImageIcon icon = new ImageIcon("image/xuan3.jpg");
        //已选择座位
        ImageIcon icon2 = new ImageIcon("image/xuan1.jpg");
        JButton button2 = new JButton(icon2);
        //已售出
        ImageIcon icon3 = new ImageIcon("image/xuan2.jpg");
		...
		JButton button_1 ;
		if(isFlag){
			button_1 = new JButton((Icon) null);
