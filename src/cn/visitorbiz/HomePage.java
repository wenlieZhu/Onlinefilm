...
public class HomePage extends JFrame implements MouseListener
{
	...
	public HomePage()
	{
        ...
        getContentPane().add(hot);getContentPane().add(all);getContentPane().add(t1);
        getContentPane().add(t2);getContentPane().add(t3);getContentPane().add(mb1);
        getContentPane().add(mb2);getContentPane().add(mb3);
