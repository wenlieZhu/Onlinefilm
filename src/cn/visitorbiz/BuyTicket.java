...
public class BuyTicket extends JFrame implements MouseListener
{
	...
	public BuyTicket()
	{
        ...
        getContentPane().add(yylb);getContentPane().add(mb2);getContentPane().add(tp);
        getContentPane().add(name);getContentPane().add(type);getContentPane().add(score);
        getContentPane().add(grade);getContentPane().add(more);getContentPane().add(jj);
        getContentPane().add(zhuyan);getContentPane().add(zy);getContentPane().add(jianj);
        getContentPane().add(mz);getContentPane().add(lx);
	...
	public void mouseClicked(MouseEvent e)
	{
		...
		} else if (e.getSource() == table)
		{
			...
			if (JOptionPane.showConfirmDialog(null, "您还没有登录，请先登录再购票！", "提示", JOptionPane.YES_NO_OPTION,
