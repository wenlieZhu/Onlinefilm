...
public class Detail extends JFrame implements MouseListener
{
	...
	public Detail()
	{
        ...
        getContentPane().add(tp);getContentPane().add(name);getContentPane().add(type);
        getContentPane().add(person);getContentPane().add(introduce);getContentPane().add(score);
        getContentPane().add(mb1);getContentPane().add(mb2);getContentPane().add(mb3);
        getContentPane().add(mb4);getContentPane().add(mb5);getContentPane().add(buy);
